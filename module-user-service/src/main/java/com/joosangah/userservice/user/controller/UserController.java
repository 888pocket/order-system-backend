...
public class UserController {
    ...
    @GetMapping
    public UserResponse loadUser(@RequestHeader("X-Authorization-Id") Long userId) {
    ...
    @PutMapping
    public void modifyUser(@RequestHeader("X-Authorization-Id") Long userId,
    ...
    @PutMapping("/password")
    public void modifyPassword(@RequestHeader("X-Authorization-Id") Long userId,
    ...
    @GetMapping("/internal")
    public User loadInternalUser(@RequestHeader("X-Authorization-Id") Long userId) {
